...
public class CreateAccount extends AppCompatActivity {
    ...
    protected void onStart() {
        super.onStart();
        fbAuth.getCurrentUser ();//handle the already connected user
    }

    public void patientRegistration(View view) {
        if(patientRadioButton.isChecked())
        {
            doctorLinearLayout.setVisibility(View.view);
    ...
    public void patientRegistration(android.view.View view) {
    }

    public void doctorRegistration(android.view.View view) {
    }

    public void signUpPatient(android.view.View view) {
    }

    public void signUpDoctor(android.view.View view) {
    }
}
